...
Gera `~/rpmbuild/RPMS/noarch/capivaraos-branding-1.0.0-1.*.noarch.rpm`.
...
A ISO final fica em
`/var/tmp/capivaraos-pup-result/CapivaraOS-Pup-1.0.0-x86_64.iso`.

## Testando a ISO

```bash
qemu-system-x86_64 -m 4096 -enable-kvm \
    -cdrom /var/tmp/capivaraos-pup-result/CapivaraOS-Pup-1.0.0-x86_64.iso
```
