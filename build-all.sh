...
ISO_NAME=CapivaraOS-Pup-1.0.0-x86_64.iso
PKG_VERSION=1.0.0
...
# OUTRAS spins (ex.: a versão KDE da Marsh, com Requires=sddm em vez de
# lightdm-gtk) caso já tenham sido buildadas na mesma máquina. Copiar com
